...
Subscribe_text_string = "Подписаться"
Home_text_string = "Главная"
Popular_text_string = "Популярное"
Trending_text_string = "В тренде"
_2015YT_text_string = "YouTube"
SearchYT_text_string = "Поиск"
Channel_Home_WIP_text_string = "Страницы каналов' ещё не готовы. Посмотрите попозже"
No_Search_Results_text_string = "Ничего не найдено. Попробуйте искать что-нибудь другое или убрать фильтры";
Dead_End_text_string = "Кажется, вы достигли конца";
Share_text_string = "Поделится";
DescMusic_text_string = "Музыка в этом видео";
LearnMore_text_string = "Больше";
Song_text_string = "Песня";
Artist_text_string = "Исполнитель";
Album_text_string = "Альбом";
SongLicensed_text_string = "Licensed to YouTube by";
Suggestions_text_string = "Suggestions";
Settings_text_string = "Настройки";
General_text_string = "Основные";
